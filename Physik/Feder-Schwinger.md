...
In der Gleichgewichtslage bei $x = 0$ übt die [Feder](Federkraft.md) keine [Kraft](Kraft.md) auf den Körper aus, bei einer Auslenkung $x$ wirkt eine [Rückstellkraft](Federkraft.md) die linear mit $x$ ansteigt.
