...
> 
> Zur Zeit $t=0$ beginnt eine [Kraft](Kräfte.md) $F$ zu wirken, wodurch es zu einer [Beschleunigung](Kinematik/Kinematik.md) der [Bewegung](Kinematik/Kinematik.md) kommt.
> 
...
Wir berechnen die [Arbeit](Kinematik/Mechanische%20Arbeit.md) $W$, die die [Kraft](Kräfte.md) $F$ entlang des Weges von $s_0$ bis $s_1$ verrichtet:
$$
