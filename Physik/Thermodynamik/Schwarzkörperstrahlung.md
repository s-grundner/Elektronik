...
\end{align*}
$$
![planckStrahlungsspektrum](../../_assets/planckStrahlungsspektrum.png)
...
$A\dots$ Fläche  
$T\dots$ [Temperatur](Thermodynamik/Temperatur%20und%20Teilchenmodell.md)  
...
Mit Änderung der [Temperatur](Thermodynamik/Temperatur%20und%20Teilchenmodell.md) verändert sich auch das abgestrahlte Spektrum, insbesondere auch die Wellenlänge des Strahlungsmaximums.  
Mit steigender [Temperatur](Thermodynamik/Temperatur%20und%20Teilchenmodell.md) T wird die Wellenlänge des Strahlungsmaximums somit kleiner.
