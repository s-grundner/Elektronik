...
Die [lineare DGL 1. Ordnung](../../Mathematik/Analysis/Differentialgleichungen/lineare%20DGL%201.%20Ordnung.md) löst sich wiefolgt:
...
Der homogene Teil wird mittels dem [Exponentialansatz](../../Mathematik/Analysis/Differentialgleichungen/lineare%20DGL%201.%20Ordnung.md) gelöst:
...
Der Lösung der inhomogenen DGL wird anhand des [](../../Mathematik/Analysis/Differentialgleichungen/lineare%20DGL%201.%20Ordnung.md#Lösung%20der%20inhomogenen%20DGL%201%20Ordnung|Störterms) $-k\cdot T_{umgebung}$ ermittelt:
