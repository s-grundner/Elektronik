...
Nur bei ihnen ist die Zerlegung in leichtere Kerne und mit Freisetzung von [Bindungsenergie](physik/Bindungsenergie.md) möglich.
...
Durch die Änderung der [Bindungsenergie](physik/Bindungsenergie.md) nimmt die Gesamtmasse entsprechend ab (Massendefekt).
