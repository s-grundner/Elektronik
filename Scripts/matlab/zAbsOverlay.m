function zAbsOverlay(b, a)
    % zAbsOverlay - Plots an overlay of the frequency spectrum above the unit circle in the complex z-Plane. Poles and zeros are displayed aswell.
    %
    % Syntax
    %   zAbsOverlay(b, a)      
    %
