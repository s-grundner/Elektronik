...
![invert_light|650](../_assets/Ionen-bdn.png)

- wichtigste Art der Bindung zwischen [Metallen](Metallbindung.md) und Nichtmetallen
- $\Delta EN > 1.7$
- Stoffe mit Ionenbindung nennt man **Salze**
- Nichtmetall mit größerer EN entreißt dem [Metall](Metallbindung.md) dessen [Valenzelektron](Valenzelektronen.md)
...
![invert_light|300](../_assets/IonAnord.png)
...
- Wechselnde [Ladung](../Elektrotechnik/Elektrostatik/Elektrisches%20Feld.md) bei Nebengruppen
- Die Summenformel beschreibt das Atomzahlverhältnis im Kristall.
- **Die Ladungszahl ($^{+/-}$)** (= Ionenwertigkeit) gibt an, w.v. positive oder Negative [Ladungen](../Elektrotechnik/Elektrostatik/Elektrisches%20Feld.md) ein Ion Trägt
- In einem Salz entsprechen eine bestimmte Anzahl positiver [Ladungen](../Elektrotechnik/Elektrostatik/Elektrisches%20Feld.md) **gleich viele** negative [Ladungen](../Elektrotechnik/Elektrostatik/Elektrisches%20Feld.md) $\rightarrow$ Die Verbindung ist *elektrisch neutral*
...
Komplexes Kation: $NH_{4}^{+}$ Ammoniumion "+ [Geladen](../Elektrotechnik/Elektrostatik/Elektrisches%20Feld.md)"  
