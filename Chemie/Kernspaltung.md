...
Nur bei ihnen ist die Zerlegung in leichtere Kerne und mit Freisetzung von [Bindungsenergie](../Chemie/Bindungsenergie.md) möglich.
...
Durch die Änderung der [Bindungsenergie](../Chemie/Bindungsenergie.md) nimmt die Gesamtmasse entsprechend ab (Massendefekt).
...
![Kernspaltung](../_assets/Kernspaltung.png)

Treffen die bei einer Kernspaltung **frei werdenden Neutronen** auf weiteres **spaltbares Material** und haben sie darüber hinaus die "**richtige**" [Geschwindigkeit](Kinematik/Kinematik.md), so können sie **weitere Kernspaltungen** hervorrufen.  
