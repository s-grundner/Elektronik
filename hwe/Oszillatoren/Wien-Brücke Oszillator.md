...
- $kHz-MHz$ Bereich
- geringer [Klirrfaktor](hwe/Klirrfaktor.md)
- breit durchbestimmbar unter Verwendung von Doppel-Poti oder Doppel-Dreh-[Kondensator](hwe/Kapazität.md). 

## Schaltung
![1000](hwe/Oszillatoren/assets/WB.png)
...
>[!hint] [Barkhausen Kriterium](hwe/Oszillatoren/Barkhausen%20Kriterium.md)
> $k\cdot v = 1$
