...
> [!question] [Gruppenlaufzeit](Zeitkontinuierlich/Gruppenlaufzeit.md) :LiRefreshCcw:

---

$H\left( e^{ j\Omega } \right)$ ist der [Frequenzgang](Übertragungsfunktion.md) eines zeitdiskreten LTI-Systems.
