...
---
 ...
 Für die Übertragungsfunktion eines Zeitdiskreten Systems, bildet man die [einseitige z-Transformation](../Frequenzbereichsmethoden/z-Transformation.md) dessen Impulsantwort. 
...
Das Funktioniert nur wenn das LTI-System [BIBO-Stabil](../Frequenzbereichsmethoden/z-Transformation.md#^BIBO) ist, da nur dann der Einheitskreis teil des Konvergenzgebietes ist. Diese Auswertung ist identisch zur [DTFT](../Frequenzbereichsmethoden/Zeitdiskrete%20Fourier-Transformation.md).
...
> [!question] [q-Transformation](../Frequenzbereichsmethoden/q-Transformation.md)
