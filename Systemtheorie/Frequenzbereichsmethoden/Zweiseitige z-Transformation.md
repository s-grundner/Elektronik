...
> [!question] [Einseitige z-Transformation](Frequenzbereichsmethoden/z-Transformation.md)
...
Zur Anwendung kommt daher meist nur die [Einseitige z-Transformation](Frequenzbereichsmethoden/z-Transformation.md).
...
Es sei $F(z)$ für alle $\lvert z \rvert \geq R$ holomorph, dann ist $F(z)$ eindeutig in eine (Laurent-) Reihe der Form wie in [1ZTR](Frequenzbereichsmethoden/z-Transformation.md#^1ZTR).
