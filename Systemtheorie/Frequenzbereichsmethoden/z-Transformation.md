...
- :LiRefreshCcw: [Laplace-Transformation](Frequenzbereichsmethoden/Laplacetransformation.md) ***:LiArrowBigRightDash:***
- [q-Transformation](Frequenzbereichsmethoden/q-Transformation.md)

---

> [!quote]- Die z-Transformation ist eine Erweiterung der [Zeitdiskrete Fouriertransformation](Frequenzbereichsmethoden/Poissonsche%20Summenformel.md#**Zeitdiskrete**%20Fouriertransformation)
>
...
>
> Die z-Transformation spielt bei zeitdiskreten Signalen die gleiche Rolle wie die [Laplacetransformation](Frequenzbereichsmethoden/Laplacetransformation.md) bei kontinuierlichen Signalen.
...
> 3. Die z-Transformierte ist für $z=\exp (j\Omega)$ (am Einheitskreis, also $r=1$) identisch mit der [DTFT](Frequenzbereichsmethoden/Zeitdiskrete%20Fourier-Transformation.md)

3. $\implies$ Der **Frequenzgang** ist auf der Zylinderebene des Einheitskreises Abgebildet (siehe [Übertragungsfunktion](Zeitdiskret/Übertragungsfunktion.md)) 
...
> > ![](Frequenzbereichsmethoden/Korrespondenzen/z-Transformation.md#^Z-T1) 
> 
> > [!question]- Folgenschreibweise
> > ![](Frequenzbereichsmethoden/Korrespondenzen/z-Transformation.md#^Z-T2) 
...
> [!satz]- **S)**
> ![z-Transformation](Frequenzbereichsmethoden/Korrespondenzen/z-Transformation.md#^Z-T3)

# Motivation der Z-TRF für DZGL

> [!info] [Differenzengleichung](../../Mathematik/Analysis/Numerische%20Verfahren/Differenzengleichung.md)
