...
| :----- | :----------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------: |
| (i)    | **Transformation**                   |                                                                 $f(t)$                                                                  |                           $\mathcal{F}\{f(t)\}(j\omega)=\displaystyle\int_{-\infty}^{\infty}f(t)e^{ j\omega t }\mathrm{~d}t$                           |
| (ii)   | **inverse<br>Transformation**        | $\mathcal{F}^{-1}\{F(j\omega)\}(t)=\dfrac{1}{2\pi}\displaystyle\int_{-\infty}^{\infty}F(j\omega)e^{ j\omega t }\mathrm{~d}\omega$ |                                                                         $F(j\omega)$                                                                         |
