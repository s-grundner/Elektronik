...
[Fourierreihe](../Zeitkontinuierlich/Fourierreihe.md) ***:LiArrowBigRightDash:***
...
> [!info] Anwendung der [Einheitswurzel](Signalverarbeitung/Einheitswurzel.md).
...
Diese Darstellung ist äquivalent zur [komplexen Fourierreihe](../Zeitkontinuierlich/Fourierreihe.md#Komplexe%20Fourierreihe) in diskreter Form. Mit $F[k]$ als **Entwicklungskoeffizienten** der **Periodischen Folge** $f[n]$, anstelle der Spektralkoeffizienten $X_{k}$.
...
Wegen der [Periodizität der Einheitswurzel](Signalverarbeitung/Einheitswurzel.md#Periodizität) $W^{kn}_{N}$ in $k$ mit der Periode $N$
