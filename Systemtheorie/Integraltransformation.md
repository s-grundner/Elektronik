...
> [!example] Beispiele:
> 
> - [Fouriertransformation](Frequenzbereichsmethoden/Fouriertransformation.md): Darstellung über Zeit oder Frequenz
...
> [!example] Ein Beispiel dafür ist die [Fouriertransformation](Frequenzbereichsmethoden/Fouriertransformation.md) bei der $T=S=\mathbb{R}$ und $s=\omega=2\pi f$ mit den Transformationskernen
> 
> $$
> \begin{align}
