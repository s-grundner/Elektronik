...
[Zeitdiskrete Fourierreihe](../Frequenzbereichsmethoden/Zeitdiskrete%20Fourierreihe.md) ***:LiArrowBigRightDash:***
...
> 
> > [!info] $\delta_{k,m}\dots$ [Kronecker-Delta](../../Mathematik/Delta-Impuls.md): Nur der Anteil, bei dem $l=k$ ist zählt.
...
> [Klirrfaktor](../../Analog-Design/Oszillatoren/Klirrfaktor.md) … $k=\dfrac{\sqrt{(\frac{2}{\pi})^{2}+(\frac{6}{5\pi})^{2}}}{\sqrt{(\frac{6}{\pi})^{2}+(\frac{2}{\pi})^{2}+(\frac{6}{5\pi})^{2}}} = 0.3623$
