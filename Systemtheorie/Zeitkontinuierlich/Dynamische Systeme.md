...
[Dynamische Systeme](../Zeitdiskret/Dynamische%20Systeme.md) ***:LiRefreshCcw:***
...
> - Existenz einer Lösung nach [Picard-Lindelöf](../../Mathematik/Analysis/Differentialgleichungen/Picard-Lindelöf.md)
> - Stabilität einer Lösung nach [Ljapunov](../../Mathematik/Analysis/Differentialgleichungen/Ljapunov.md)
...
Linearisiert man allgemein entlang einer Trajektorie, ist das linearisierte System [zeitvariant](Lineare%20Systeme.md)

Linearisiert man um eine **Ruhelage** des Systems, dann ist das linearisierte System [zeitinvariant](LTI-Zustandsraum.md) (LTI)

$\Delta x$ abweichung von der Ursprünglichen Lösungstrajektorie
