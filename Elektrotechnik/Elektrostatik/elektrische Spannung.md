...
>
> $$
> U_{12} = \varphi_{1} - \varphi_{2} = \int_{1}^{2}\mathbf{E}\cdot\mathrm{d}\mathbf{s} \qquad [U] = \mathrm{V} = \mathrm{\frac{kg~m^{2}}{A~s^{3}}}
> $$

> [!question]- Zerlegung in [SI-Einheiten](../../Physik/Konstanten%20und%20Einheiten/SI-Einheiten.md)
> 
> $$
> \mathrm{V}=[U]=[E][l]=\frac{[F][l]}{[Q]}=\frac{[m][a][l]}{[I][t]}=\frac{[m] \frac{[v]}{[t]}[l]}{[I][t]}=\frac{[m] \frac{[l]}{[t][t]}[l]}{[I][t]}=\frac{\mathrm{kg} \frac{\mathrm{~m}}{\mathrm{~s}^2} \mathrm{~m}}{\mathrm{As}} = \mathrm{\frac{kg~m^{2}}{A~s^{3}}}
> $$

Die elektrische Spannung ist die Differenz des Potentials zweier [Ladungen](Elektrisches%20Feld.md) in einem [Elektrischen Feld](Elektrisches%20Feld.md).

- Potential: Wir erinnern uns an die [potentielle Energie](../../Physik/Kinematik/Energieerhaltung.md).
- [Arbeit](../../Physik/Kinematik/Mechanische%20Arbeit.md): $\mathrm{d}W = \vec{F}\cdot \mathrm{d}\vec{s}$ (Skalarprodukt: Kraft projiziert auf den Weg)
...
Mit dem zusätzlichen Faktor der [Ladung](Elektrisches%20Feld.md) muss für die Spannung auch *[Arbeit](../../Physik/Kinematik/Mechanische%20Arbeit.md) pro [Ladung](Elektrisches%20Feld.md)* gelten ($U = \frac{W}{q}$)
