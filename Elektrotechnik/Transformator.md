...
- Die Transformation von Spannungen, Ströme und/oder Impedanzen ist nur für *zeitlich veränderliche* Spannungen/Ströme möglich, da diese auf dem Prinzip der [Ruheinduktion](../Elektrotechnik/Magnetostatik/Magnetisches%20Feld.md) beruht -> gekoppelte Induktivitäten.
...
> Torbedingung: [Strom](../Elektrotechnik/Elektrostatik/elektrischer%20Strom.md) $i_{1}$ der oben hinein fließt, muss unten (als $i_{2}$) wieder herausfließen.

> [!warning] Vereinfachungen  
> kein [Magnetisches Feld](../Elektrotechnik/Magnetostatik/Magnetisches%20Feld.md) außerhalb des Eisenkerns
...
[Strom](../Elektrotechnik/Elektrostatik/elektrischer%20Strom.md) muss seiner Ursache entgegenwirken
...
> - Wird die Spannung um einen Faktor nach oben Transformiert, wird der [Strom](../Elektrotechnik/Elektrostatik/elektrischer%20Strom.md) um den selben Faktor verringert
> 	- $P=U\cdot I$
