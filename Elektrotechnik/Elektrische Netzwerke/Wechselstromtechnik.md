...
Wird ein [elektrisches Netzwerk](index.md) mit Wechselstrom betrieben, so kann die [komplexe Rechnung](../../Mathematik/Algebra/Komplexe%20Zahlen.md) zur Ermittlung der Spannungen und Ströme des Netzwerks angewendet werden. Dies gilt nur unter bestimmten Vorraussetzungen. 

> [!hint] Vorraussetzungen:
> - [Netzwerk](index.md) ist linear
...
> 
> -  [Ohmsches Gesetz](../Elektrostatik/Ohmsches%20Gesetz.md) $R$
> 
> $$
> \begin{aligned}
...
> $$
> 
> - [Kondensator](Elektrische%20Netzwerke/Kapazität.md) $C$
> 
> $$
> \begin{align}
> i(t) &= C \frac{du(t)}{dt}\\
