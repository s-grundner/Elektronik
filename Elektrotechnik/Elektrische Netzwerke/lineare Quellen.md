...
> - Die *Leerlaufspannung* $U_{L}$: Jene [elektrische Spannung](Elektrostatik/elektrische%20Spannung.md) die im Leerlauf an den Klemmen anliegt
> - Den *Kurzschlussstrom* $I_{K}$: Der [Strom](Elektrostatik/elektrischer%20Strom.md) der bei Kurzschluss zwischen den Klemmen fließt
...
> siehe: [Spannungsquelle](Elektrostatik/elektrische%20Spannung.md) 

## Norton ESB: [Stromquelle](Stromquelle.md)
...
## Thevenin ESB: [Spannungsquelle](Elektrostatik/elektrische%20Spannung.md)
...
> [!important] Bei $R_{a} = 0$ ist der der [Strom](Elektrostatik/elektrischer%20Strom.md) $I_{K} = \frac{U_{L}}{R_{i}}$ der Quellstrom des Norton ESB
...
> Wenn Sie als Last eine *Quelle* (egal ob Spannungsoder Stromquelle) anschließen, so könnten Sie sowohl im Ersatzbild als auch in der echten Schaltung den Beitrag dieser Quelle durch das [[../../Dictionary/Superposition]] bestimmen.
