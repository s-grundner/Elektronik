...
| **Stromquellen:**         | Treten in dem Netzwerk Spannungsquellen auf, werden diese mit Hilfe des [Norton](lineare%20Quellen.md)-Ersatzbildes in Stromquellen umgewandelt.<br>(Nur bei realen Quellen mit Innenwiderstand möglich - siehe [Ideale Quellen](Knotenpotentialverfahren.md#Ideale%20Quellen)) |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> ![1200](../../_assets/Excalidraw/Knotenpotentialverfahren%202024-03-13%2021.34.50.excalidraw.md)
...
> [!success] Wenn eine Reale Lineare Spannungsquelle vorliegt kann diese in das [Norton](lineare%20Quellen.md) ESB umgewandelt werden
