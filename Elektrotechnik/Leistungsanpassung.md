...
> Der Abschlusswiderstand $R_{a}$ an dem die maximale [Leistung](elektrische%20Leistung.md) umgesetzt wird, lässt sich mit einem Satz aus der [Kurvendiskussion](../Mathematik/Analysis/Kurvendiskussion/index.md) ermitteln. Dieser besagt, dass wenn die erste [Ableitung](../Mathematik/Analysis/Differenzialrechnung.md) an einem Wert der Funktion 0 ergibt, dieser Punkt ein lokales [Maximum](../Mathematik/Analysis/Kurvendiskussion/Extremwert.md) oder [Minimum](../Mathematik/Analysis/Kurvendiskussion/Extremwert.md) ist.
