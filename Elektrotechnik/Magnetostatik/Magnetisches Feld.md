...
> [!question] [Elektrisches Feld](Elektrostatik/Elektrisches%20Feld.md) :LiRefreshCcw:
...
- [Magnetischer Fluss](Magnetostatik/Magnetischer%20Fluss.md) - $\Phi$
- [Durchflutung](Magnetostatik/Durchflutung.md) - $\Theta$
...
> Die Feldlinien sind konzentrische Kreise, die den stromführenden Leiter rechtswendig (s. Rechte-Hand-Regel) „umwirbeln“. Feld um einen (*unendlich ausgedehnten*) langen Draht der den [Strom](Elektrostatik/elektrischer%20Strom.md) 𝐼 führt:
>
...
> > Um die Größe des Magnetfelds darzustellen kann der Fluss durch eine Fläche bestimmt werden (z.B. Der Querschnitt einer [Spule](../Elektrische%20Netzwerke/Induktivität.md))
