...
> [!question] Themengebiet: [Magnetfeld](../Magnetostatik/Magnetisches%20Feld.md)
...
| ----------------------------------------: | :--------------------------------------------------: | :------------------------------------------: | :------------------ |
| [magn. Fluss](../Magnetostatik/Magnetischer%20Fluss.md) |                        $\Phi$                        |                     $I$                      | Strom               |
...
|        [Durchflutung](../Magnetostatik/Durchflutung.md) | $\Theta = \oint \mathbf{H}\cdot\mathrm{d}\mathbf{s}$ | $u=\int \mathbf{E}\cdot\mathrm{d}\mathbf{s}$ | induzierte Spannung |

> [!success] Oft hat man mehrere Maschen in einem Magnetkreis.
> Ist dies der Fall, so bietet sich das [Maschenstromverfahren](../Elektrische%20Netzwerke/Maschenstromverfahren.md) aus der Elektritechnik an, um schnell eine [LGS](../../Mathematik/Algebra/Lineare%20Gleichungssysteme.md) für die magnetischen Flüsse aufzustellen. 
...
- [Magnetische Quellen](../Magnetostatik/Magnetische%20Quellen.md) - Magnete
...
![invert_dark|300](../../_assets/KreisBsp.png)
...
1. Ausgangspunkt ist die Definition der [Durchflutung](../Magnetostatik/Durchflutung.md)
...
3. Beziehungen Anwenden ^MK-EX-3
    ...
    - [Magnetischer Fluss](../Magnetostatik/Magnetischer%20Fluss.md): $\Phi = \int _{A}\mathbf{B}\cdot \mathrm{d}\mathbf{a} = B\cdot A$. Dazu mit den Querschnittsflächen $A$ jeder Sektion des Modells erweitern
...
![invert_dark|400](../../_assets/MagnEquiv.png)
