...
Eine *periodische* Funktion $f$ lässt sich in Form der [[Fourier Reihe|Fourier-Reihe]] als Summe unendlich vieler **Sinusschwingungen** darstellen.
...
Dadurch entsteht aus einer reellen Funktion $f$ eine [[Komplexe Zahlen|komplexwertige]] Funktion $F$.

Man sagt, dass die Zeitfunktion $f$ im **Original-** oder **[[Komplexe Zahlen|Zeitbereich]]** liegt, während ihre Fourier-Transformierte im **Frequenz-** oder **[[Komplexe Zahlen|Bildbereich]]** liegt.
