...
In phpMyAdmin wird eine [Datenbank](../Datenbank/Datenbank.md) mit dem Namen **crud-intro** angelegt und mit Daten befüllt:
...
### 6. [Datenbank](../Datenbank/Datenbank.md) SELECT

Ein bisschen mehr: Mit get wird eine Verbindung zur [Datenbank](../Datenbank/Datenbank.md) hergestellt, ein Select ausgeführt und das Ergebnis get zurückgegeben und in der Konsole ausgegeben. Daraufhin wird die DB-Verbindung beendet. **server.js**:
...
Für dieses Beispiel ist eine lokale MongoDB-[Datenbank](../Datenbank/Datenbank.md) notwendig. Der Server muss lokal laufen (zum Beispiel als Service) und eine *MyDB*-[Datenbank](../Datenbank/Datenbank.md) beinhalten mit einer (beliebigen) *person*-Collection (siehe *NoSQL-Datenbanken-Skriptum*).
...
- Node.js - Serverseitige JavaScript-Laufzeitumgebung
  ...
  - [Node-Red](Node-RED.md)->[Datenbank](../Datenbank/Datenbank.md): <https://flows.nodered.org/node/node-red-node-mysql>
