...
> [!EXAMPLE] Beispiel
> 
> Die [Grenzfrequenz](../../Analog-Design/Filter-Verstärker/Grenzfrequenz.md) eines digitalen Filters kann mittels eines MIDI enkodierten Potentiometers am MIDI-Controller gesteuert werden.
> 
...
| System Messages   | 0xF      | MIDI [Clock](../../Analog-Design/Oszillatoren/Clock-Generierung.md), Start, Stop, System [Reset](../Reset%20Generierung.md), Active Sensing |
|                   |          |                                                                                                                                                                            |
