...
- Definieren Interface einer Teilschaltung
- Ports sind input (`in`), output (`out`), und bidirektional (`inout`)
- Outputs können nicht gelesen werden, inputs nicht beschrieben

## Architecture

- Pro entity kann es mehrere architectures geben
	- Unterstützung verschiedener Realisierungen
	- Damit Optimierung nach verschiedenen Kriterien (z.B. Fläche, Leistung, Verzögerungszeit, ...)
- Standardmäßig wird die zuletzt analysierte Architecture benutzt. Die Benutzung einer anderen Architecture kann in einer *configuration* vorgeschrieben
- Architecture-Beschreibungen können
	- **Strukturbeschreibungen** sein oder
	- **Verhaltensbeschreibungen**

Struktur vs. Verhaltensbeschreibung

| Strukturbeschreibung                         | Verhaltensbeschreibung                                        |
| -------------------------------------------- | ------------------------------------------------------------- |
| Sicht: „wie man es macht“                    | Sicht: "was ist zu machen"                                    |
| Nutzen von Komponenten (insbesondere Gatter) | Verwendung von Prozessen                                      |
| Verdrahtung von Komponenten                  | In Prozessen: sequentielle Anweisungen, Bedingungen (if usw.) |
|                                              | Höhere Abstraktion als Strukturbeschreibung                   |

### Strukturbeschreibung (Structural)



### Verhaltensbeschreibung (Behavioural)
...
![invert_dark|700](../../_assets/Pasted%20image%2020260325163324.png)
