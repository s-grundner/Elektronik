...
- [index](../../Softwareentwicklung/Datenbanken/index.md): eine Datenbankanwendung (php, c# …) kommuniziert mit einer [index](../../Softwareentwicklung/Datenbanken/index.md) (DB-Server)
...
![img](../../_assets/NW_Schichtenmodell_Poster.png)
