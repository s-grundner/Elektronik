...
Die run-Methode wird automatisch gestartet, wenn ein Objekt mit der Runnable-[Schnittstelle](../../Digitaltechnik/{MOC}%20Schnittstellen.md) als Thread gestartet wird:
