...
Die run-Methode wird automatisch gestartet, wenn ein Objekt mit der Runnable-[Schnittstelle](../../digital-technik/{MOC}%20Schnittstellen.md) als Thread gestartet wird:
