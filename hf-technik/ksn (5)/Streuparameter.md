...
- Beschreiben z.B. [Filter](Filter), [Antenne](Antenne.md), [Mischer](../ksn%20(4)/Mischer.md)
...
womit sich mit der [Impedanz](../../hwe/Impedanz.md) $Z_{0}$ des Messsystems der [Reflexionsfaktor](../ksn%20(4)/Reflexionsfaktor.md) $r_{\nu}$ beschreiben lässt als:
$$r_\nu = \dfrac{b_\nu}{a_\nu} = \dfrac{Z_\nu - Z_0}{Z_\nu + Z_0}, \qquad b_\nu = r_\nu \cdot a_\nu$$

Im einfachsten Fall eines **Eintors** ist der skalare [Reflexionsfaktor](../ksn%20(4)/Reflexionsfaktor.md) $r$ gleich dem einen und **einzigen S-Parameter $S_{11}$**.
