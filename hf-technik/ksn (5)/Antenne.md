...
- Im <mark style="background: #FFB86CA6;">Sendefall</mark>: Antenne wandelt an die an ihrem [Tor](Streuparameter.md) zugeführte [Leistung](Elektrische%20Leistung.md) möglichst effizient in eine [EM-Welle](../../physik/Elektromagnetische%20Wellen.md) um.
- Im <mark style="background: #FFB86CA6;">Empfangsfall</mark>: Die Antenne nimmt aus einen [EM-Wellenfeld](Elektromagnetische%20Wellen.md) [Leistung](../../physik/Elektrische%20Leistung.md) auf und stellt diese an ihrem [Netzwerktor](Streuparameter.md) zur Verfügung.
...
$\vec{H}\dots$ [H-Feldstärke](Magnetisches%20Feld#Magnetisches%20Feld)
