...
Soll für einen speziellen Datentyp in ein Template eine eigene [Logik](../../Mathematik/Logik/Aussagenlogik.md) eingebaut werden, funktioniert das mittels *Spezialisierung*:
