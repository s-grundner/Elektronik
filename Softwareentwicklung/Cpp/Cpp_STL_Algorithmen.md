...
Der Algorithmus kann [komplexe Zahlen](../../Mathematik/Analysis/Komplexe%20Zahlen.md) nicht sortieren weil der < Operator dafür nicht definiert ist.
...
Sie dreht die < [Logik](../../Mathematik/Logik/Aussagenlogik.md) um, damit kann in umgekehrter Reihenfolge sortiert werden. Voraussetzung ist, dass wie oben, der < Operator definiert wurde. Damit kann Sortiert werden:
