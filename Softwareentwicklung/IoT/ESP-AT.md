...
Von dem entsprechenden Modul (hier der [index](../../Digitaltechnik/ESP32/index.md)-WROOM) muss nun die empfohlene Version der Firmware heruntergeladen werden.  
...
> [!success] Der Bootloader sollte nun erfolgreich auf den [index](../../Digitaltechnik/ESP32/index.md) gebrannt worden sein