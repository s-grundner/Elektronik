...
Ein [Betriebssystem](../../Chemie/index.md) ist die **Software**, die **den Betrieb Computers ermöglicht**.
...
Ein [Betriebssystem](../../Chemie/index.md) hat folgende grundlegende Aufgaben:  
...
- Abstrakte Maschine = Reale Maschine + [Betriebssystem](../../Chemie/index.md)
...
Zur logischen Strukturierung wird das [Betriebssystem](../../Chemie/index.md) normalerweise in mehrere **Schichten** oder Schalen eingeteilt.  
...
- Die darauf folgende Schicht behandelt **Kommunikationsund** **Netzwerkdienste**, **Dateien und** **Dateisysteme**. Weitere Schichten können je nach Anforderung folgen. Ein [Betriebssystem](../../Chemie/index.md) besitzt also drei oder mehr logische Schichten.
...
**Das BS stellt also eine** **definierte Programmierschnittstelle** **zur Verfügung**. Änderungen am BS oder der Hardware wirken sich so nicht auf die Anwenderprogramme aus, die nach wie vor über die gleichen [Betriebssystem](../../Chemie/index.md)-Aufrufe die Dienste des BS in Anspruch nehmen.
...
- **Prozess**
  ...
  Wird ein Programm/Prozedur in einem [Betriebssystem](../../Chemie/index.md) **ausgeführt**, so wird dieser Ablauf als **Prozess** (**Task**) bezeichnet. Bei der Ausführung von Prozessen entstehen Statusinformationen (Registerinhalte …).
