...
Das MVC-Pattern ist Keines der GoF, allerdings hat es sich für GUI-Anwendungen sehr bewährt. Dabei geht es darum graphische Kontrollelemente von der [Logik](../../../Mathe/Aussagenlogik.md) zu trennen:
...
- Die Darstellung ist unabhängig von der (eventuell komplexen) [Logik](../../../Mathe/Aussagenlogik.md) und kann unabhängig von den anderen Teilen verändert werden.
