...
- [Rekursiv](Algorithmen/Rekursion.md) kann die Teilung bis zu einem 1 großen Feld zerlegt werden.
...
- Das zu sortierende Feld kann beliebig aufgeteilt und sortiert werden, daher ist der Algorithmus zum Sortieren großer Datenmengen geeignet (einfach mittels [Rekursion](Algorithmen/Rekursion.md)).
