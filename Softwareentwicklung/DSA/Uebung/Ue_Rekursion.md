...
# [Rekursion](../Algorithmen/Rekursion.md) - Übungen
...
Zählen von einer Zahl bis zu einer zweiten Zahl [rekursiv](../Algorithmen/Rekursion.md):
...
Wird hier ein entsprechend großer Bereich eingeben, dann bricht auch hier das Programm aufgrund eines Stack-Overflow ab ([Rekursiv](../Algorithmen/Rekursion.md) häufig ineffizient).
...
> [!EXAMPLE] [Rekursiv](../Algorithmen/Rekursion.md) kann eine Multiplikation sehr einfach in eine Addition überführt werden (so machen wir das auch wenn wir im Kopf rechnen):  
> mult(a, b) = 0						für b = 0  
...
> [!EXAMPLE] Auch eine Division kann durch eine [Rekursion](../Algorithmen/Rekursion.md) relativ einfach gelöst werden (ohne Verwendung von "%" und "/").  
> `div(a, b) = 0 //für b > a`  
> `div(a, b) = 1 + div(a-b, b) //sonst`

## Ganzzahlige Subtraktion

> [!EXAMPLE] Subtraktion [rekursiv](../Algorithmen/Rekursion.md):  
> ​sub(a, b) = a					für b = 0  
...
- [Mandelbrot](../Algorithmen/Mandelbrot.md)
...
In diesem Beispiel ist sehr schön sichtbar, dass eine umfassende Lösung sehr [komplex](../../../Mathematik/Algebra/Komplexe%20Zahlen.md) ist, durch eine schrittweise Vereinfachung des Problems kann [rekursiv](../Algorithmen/Rekursion.md) eine sehr einfache Lösung gefunden werden. Das klassische Beispiel sind 64 Scheiben (in Gold und von Priestern zu bewegen). Um die Aufgabenstellung zu lösen, müssen über 500 Milliarden (!) Züge getätigt werden.
