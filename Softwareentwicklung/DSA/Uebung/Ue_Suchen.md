...
- Eine zweite Suchfunktion sucht nach einer Personalnummer. Hier soll die Funktion [rekursiv](../Algorithmen/Rekursion.md) implementiert werden.
...
## 7 Visuelle Darstellung Von Suchverfahren - Binäre Suche
