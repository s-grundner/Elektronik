...
[Komplexe Zahlen](../../Mathematik/Algebra/Komplexe%20Zahlen.md) beinhalten immer 2 Zahlen. Mit einem primitiven Rückgabewert könnte man lediglich den Realoder Imaginärteil zurückgeben. Wird eine [komplexe Zahl](../../Mathematik/Algebra/Komplexe%20Zahlen.md) in ein Feld gekapselt, dann kann die komplette Zahl zurückgegeben werden.
