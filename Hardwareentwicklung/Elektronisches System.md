...
| [Phase Frequnecy Detectors](Hardwareentwicklung/Oszillatoren/Phase%20Locked%20Loop.md) | ![invert_dark\|100](../_assets/PFD%201.png)        | $i_{\text{out}} = K_{\phi}(\phi_{1}(t) + \phi_{2}(t))$ |
