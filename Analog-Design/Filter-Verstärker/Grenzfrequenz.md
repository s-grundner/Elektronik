...
Jene Frequenz bei der das [maximum](../../Mathematik/Analysis/Kurvendiskussion/Extremwert.md) einer Übertragungsfunktion $T(\omega)$ um $3dB$ (Faktor $\frac{1}{\sqrt{ 2 }}$) gedämpft ist. 
