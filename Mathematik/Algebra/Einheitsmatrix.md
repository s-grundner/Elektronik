...
> 
> $$
> \mathbf{I}_{n}=\begin{pmatrix} 1 & 0 & \cdots & 0 \\ 0 & 1 & \ddots & \vdots \\ \vdots & \ddots & \ddots & 0 \\ 0 & \cdots  & 0 & 1 \end{pmatrix} \in R^{n\times n}
> $$
...
## [Determinante](Determinante.md) Der Einheitsmatrix $\mathbf{I}_n$ :

$$
\operatorname{det}\left(\mathbf{I}_n\right)=1 \text {. }
$$
...
$$
\mathbf{I}_{n}= (\delta _{ij})_{i,j \in \{1,\dots,n\}}
$$