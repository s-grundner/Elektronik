...
Beim Expliziten Eulerverfahren geht man in kleinen Schritten $h$ von einem Anfangswert $x_{0}$ aus und berechnet den nächsten Wert $x_{1}$ durch die Tangente an der Stelle $x_{0}$. Das Eulerverfahren ist ein [explizites Einschrittverfahren](Numerische%20Verfahren/Diskretisierungsverfahren.md#Explizite%20Einschrittverfahren), bei dem die Verfahrensfunktion die Differenzialgleichung selbst ist.
