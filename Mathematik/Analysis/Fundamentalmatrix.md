...
> [!def] **FM D1)** Definition der Fundamentalmatrix
...
> [!def] **FM D2)** Definition des Martizant
...
> [!satz] **FM S1)** Sei $x(t;t_{0};x_{0})$ die eindeutige Lösung von $x'=A(t)x,\quad x(t_{0}) = x_{0}$
> 
