...
> 
> ist die einfachste Lineare [Partielle DGL](../Partielle%20Differenzialgleichung.md) zweiter Ordnung, mittels dem [Laplace Operator](Laplace%20Operator.md) $\Delta := \nabla^{2}$ Notiert:
> 
