...
- [P-Q-Formel](../../Algebra/Quadratische%20Gleichung.md)
...
| 3. Fall | $\Big{(}\dfrac{p}{2}\Big{)}^{2}-q<0$ | $\lambda_{1,2}=\sigma\pm j\cdot\omega$ <br>(2 konjugiert [komplexe](../../Algebra/Komplexe%20Zahlen.md) Lösungen) | $y_{h}=e^{\sigma x}\cdot\Big{[}C_{1}\cdot\cos(\omega x)+C_{2}\cdot\sin(\omega x)\Big{]}$ |
...
> ![Pasted image 20220601193117](../../../_assets/HTL-notes1.png)
