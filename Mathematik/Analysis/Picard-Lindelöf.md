...
> $$
> 
> Dann besitzt das [AWP](GDGL.md) im Intervall $[t_{0},t_{0}+\alpha]$ eine **eindeutige**, stetig differenzierbare Lösung $x$ (mit $\alpha$ aus [Peano](Peano.md)).
> 
...
> $$
> 
> gleichmäßig auf $\left[t_0, t_0+\alpha\right]$ für $n \rightarrow \infty$ gegen die Lösung $x$ [konvergiert](Grenzwert.md). Zusätzlich gilt auf diesem Intervall für alle $n \in \mathbb{N}_0$ die Abschätzung
> 
> $$
